...
const navigation = [
  { name: 'Dashboard', href: '/dashboard', icon: HomeIcon, roles: ['admin', 'loan_officer', 'employee'] },
  { name: 'New Loan', href: '/loan/new', icon: DocumentPlusIcon, roles: ['admin', 'loan_officer', 'employee'] },
  { name: 'Loan Records', href: '/loans', icon: FolderIcon, roles: ['admin', 'loan_officer'] },
  { name: 'Payments', href: '/payments', icon: CurrencyDollarIcon, roles: ['admin', 'loan_officer'] },
  { name: 'Outsource', href: '/outsource', icon: ArrowPathIcon, roles: ['admin', 'loan_officer'] },
  { name: 'Profile', href: '/profile', icon: UserIcon, roles: ['admin', 'loan_officer', 'employee'] },
];
